...
namespace SistemaDeHorarios.Controllers
{
    public class GruposController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,NivelEducativo")] Grupo grupo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,NivelEducativo")] Grupo grupo)
        {
            if (id != grupo.Id)
            {
                return NotFound();
