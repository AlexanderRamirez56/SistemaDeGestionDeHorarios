...
namespace SistemaDeHorarios.Controllers
{
    public class DocentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Materia,HorasMaximas")] Docente docente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Materia,HorasMaximas")] Docente docente)
        {
            if (id != docente.Id)
            {
                return NotFound();
