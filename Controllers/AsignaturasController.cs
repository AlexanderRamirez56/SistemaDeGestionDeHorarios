...
namespace SistemaDeHorarios.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,HorasSemanales")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,HorasSemanales")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
